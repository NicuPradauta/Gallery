...
public class GalleryController: UIViewController, PermissionControllerDelegate {
    ...
    func makeImagesController() -> ImagesController {
        ...
        controller.title = Config.Localizations.galleryImagesTitle
    ...
    func makeCameraController() -> CameraController {
        ...
        controller.title = Config.Localizations.galleryCameraTitle
    ...
    func makeVideosController() -> VideosController {
        ...
        controller.title = Config.Localizations.galleryVideosTitle
    ...
    func makePagesController() -> PagesController? {
        ...
        let controllerView = controller.children.first?.view
        controllerView?.backgroundColor = .clear
        controllerView?.subviews.forEach { $0.backgroundColor = .clear }
        controllerView?.subviews.first?.subviews.forEach { $0.backgroundColor = .clear }
