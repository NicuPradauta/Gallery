...
class CameraView: UIView, UIGestureRecognizerDelegate {
  ...
  func makeFlashButton() -> TripleButton {
    let states: [TripleButton.ButtonState] = [
        TripleButton.ButtonState(title: Config.Localizations.cameraFlashOff, image: GalleryBundle.image("gallery_camera_flash_off")!),
        TripleButton.ButtonState(title: Config.Localizations.cameraFlashOn, image: GalleryBundle.image("gallery_camera_flash_on")!),
        TripleButton.ButtonState(title: Config.Localizations.cameraFlashAuto, image: GalleryBundle.image("gallery_camera_flash_auto")!)
    ]
  ...
  func makeDoneButton() -> UIButton {
    ...
    button.setTitle(Config.Localizations.done, for: UIControl.State())
